...
<div class="main_container-chil">
    <div class="mobile-container">
        <ul class="nav-list">
            <ul class="nav-list">
                ...
                ?>
                            <li><a href="<?php echo _WEB_HOST_1 ?>/laptopBrand.php?brand_id=<?php echo $item['brand_Id'] ?>"><i class="fa-solid fa-greater-than" style="font-size: 12px;"></i>
                                    <?php
                            ...
                            <li><a href="<?php echo _WEB_HOST_1 ?>/laptopDetail.php?product_id=<?php echo $item['id'] ?>"><i class="fa-solid fa-greater-than" style="font-size: 12px;"></i>
                                    <?php
                                    ...
                                    <div class="box07">
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <span><?php echo $item['cardDoHoa'] ?></span>
                                            </li>
                                            <li>
                                                <p>Dung lượng RAM</p>
                                            ...
                                            <li>
                                                <p>Loại RAM</p>
                                                <span><?php echo $item['LoaiRam'] ?></span>
                                            </li>
                                            <li>
                                                <p>Ổ cứng</p>
                                                <span><?php echo $item['oCung'] ?></span>
                                            </li>
                                            <li>
    ...
    <script src="<?php echo _WEB_HOST_1 ?>/js/iphone.js?ver= <?php echo rand() ?>"></script>
</div>
</body>
