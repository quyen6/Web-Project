...
<footer class="footer">
    <div class="ft-content-one">
        <div class="ft-logo">
            <img src="./images/footer/ft-logo.png" alt="">
        </div>
...
<script src="<?php echo _WEB_HOST_1 ?>/js/main.js?ver= <?php echo rand() ?>"></script>
<script src="<?php echo _WEB_HOST_1 ?>/js/banner.js?ver= <?php echo rand() ?>"></script>